...
Copy dev.kopernikus.pivxd.plist into ~/Library/LaunchAgents. Load the launch agent by
running `launchctl load ~/Library/LaunchAgents/dev.kopernikus.pivxd.plist`.
...
You will need to modify dev.kopernikus.pivxd.plist if you intend to use it as a
