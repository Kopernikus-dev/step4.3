...
The script [extract-osx-sdk.sh](https://github.com/kopernikus-dev/step4.3/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
encocoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/kopernikus-dev/step4.3/blob/master/doc/README_osx.md) for troubleshooting tips.