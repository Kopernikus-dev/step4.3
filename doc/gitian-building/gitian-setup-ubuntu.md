...
The build script we'll be using is contained in the EncoCoin github repository ([contrib/gitian-build.py](https://github.com/kopernikus-dev/step4.3/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the EncoCoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Kopernikus-dev/step4.3/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, encocoin-detached-sigs, and encocoin GitHub repos.
