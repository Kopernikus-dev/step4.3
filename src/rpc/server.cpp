...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EncoCoin features */
        {"encocoin", "listmasternodes", &listmasternodes, true },
        {"encocoin", "getmasternodecount", &getmasternodecount, true },
        {"encocoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"encocoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"encocoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"encocoin", "masternodecurrent", &masternodecurrent, true },
        {"encocoin", "startmasternode", &startmasternode, true },
        {"encocoin", "createmasternodekey", &createmasternodekey, true },
        {"encocoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"encocoin", "listmasternodeconf", &listmasternodeconf, true },
        {"encocoin", "getmasternodestatus", &getmasternodestatus, true },
        {"encocoin", "getmasternodewinners", &getmasternodewinners, true },
        {"encocoin", "getmasternodescores", &getmasternodescores, true },
        {"encocoin", "preparebudget", &preparebudget, true },
        {"encocoin", "submitbudget", &submitbudget, true },
        {"encocoin", "mnbudgetvote", &mnbudgetvote, true },
        {"encocoin", "getbudgetvotes", &getbudgetvotes, true },
        {"encocoin", "getnextsuperblock", &getnextsuperblock, true },
        {"encocoin", "getbudgetprojection", &getbudgetprojection, true },
        {"encocoin", "getbudgetinfo", &getbudgetinfo, true },
        {"encocoin", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"encocoin", "mnfinalbudget", &mnfinalbudget, true },
        {"encocoin", "checkbudgets", &checkbudgets, true },
        {"encocoin", "mnsync", &mnsync, true },
        {"encocoin", "spork", &spork, true },
