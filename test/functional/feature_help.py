...
"""Verify that starting encocoin with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start encocoin with -? for help text")
        ...
        self.log.info("Start encocoin with -version for version information")
