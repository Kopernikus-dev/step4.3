...
def setup_repos():
    ...
    if not os.path.isdir('pivx-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/kopernikus-dev/step4.3-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('pivx'):
        subprocess.check_call(['git', 'clone', 'https://github.com/kopernikus-dev/step4.3.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/kopernikus-dev/step4.3', help='Specify the URL of the repository. Default is %(default)s')
